...
public class TvMainActivity extends Activity implements View.OnClickListener {
    ...
    private View linedirver_control_base;
    private View linedirver_control_number;
    @Override
    ...
    protected void onResume() {
        ...
        linedirver_control_base.setVisibility(View.VISIBLE);
        linedirver_control_number.setVisibility(View.GONE);
    }
    ...
    private void initViews() {
        ...
        linedirver_control_base = findViewById(R.id.linedirver_control_base);
        linedirver_control_number = findViewById(R.id.linedirver_control_number);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.layout_title_control_number:
                ...
                linedirver_control_base.setVisibility(View.GONE);
                linedirver_control_number.setVisibility(View.VISIBLE);
                break;
        }
    }
