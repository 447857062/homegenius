package com.deplink.boruSmart.view.imageview;
...

{
		...
		mGestureDetector = new GestureDetector(context,
				new SimpleOnGestureListener()
				{
					...
					public boolean onSingleTapConfirmed(MotionEvent e) {
						...
						Intent intent=new Intent(getContext(), VistorHistoryActivity.class);
	...
	public void onGlobalLayout()
	{
		if (once)
		{
			...
			// (同上)如果宽和高都小于屏幕，则让其按按比例适应屏幕大小
			if(dw<width && dh<height){
				scale=width * 1.0f / dw;
			}
			initScale = scale;

			Log.e(TAG, "initScale = " + initScale+"dw="+dw+"dh="+dh+"width="+width+"height="+height);
