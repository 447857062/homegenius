...
import com.deplink.boruSmart.Protocol.json.device.lock.alertreport.ReportAlertRecord;
import com.deplink.boruSmart.Protocol.packet.GeneralPacket;
import com.deplink.boruSmart.constant.AppConstant;
import com.deplink.boruSmart.manager.connect.ConnectionMonitor;
...
public class LocalConnectmanager extends Binder implements UdpManagerGetIPLintener {
     ...
     * 初始化本地连接管理器
     */
    public void InitLocalConnectManager(Context context, String bindAppAuth) {
    ...
    public void onGetLocalConnectIp(String ipAddress, String uid) {
        List<GatwayDevice> mGatwayDevices = DataSupport.findAll(GatwayDevice.class);
